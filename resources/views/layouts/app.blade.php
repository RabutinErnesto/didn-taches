    ...
    <div id="app">
                                ...
                                <div class="notifications-body">
                                    <p class="notification-texte mx-1">
                                        <small><span
                                            ...
                                            t'a affecté la tache {{ $notification->data['nom_tache'] }}</small></p>
                                </div>
        ...
        <footer class="footer text-center">
            <footer class="footer text-center px-auto">
                <p>App made by <a href="">DIDN/SDNL</a> with
                        <a href="http://www.facebook.com/ernestorabutin" target="blank"> Rabutin</a></p>
            </footer>
        </footer>
    </div>
